  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-section-links">
          <ul>
            ...
            <li>
              {" "}
              <a href="mailto:pmguez1287@gmail.com">
        ...
        <div className="footer-section-social">
          <h2 className="footer-section-title-2">Redes Sociales</h2>
          <ul>
            <li>
              <a href="mailto:pmguez1287@gmail.com">
            ...
            <li>
              <a href="https://www.instagram.com/ejemplo">
            ...
            <li>
              <a href="https://www.linkedin.com/company/ejemplo">
      ...
      <div className="footer-bottom">
        <p className="clase-p1">
          Derechos de autor &copy; {new Date().getFullYear()} Ejemplo.com. Todos
